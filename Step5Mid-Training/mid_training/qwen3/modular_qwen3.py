...
try:
    ...
    # transformers >=5.0 removed LossKwargs; use fallback.
    # LossKwargs must be a TypedDict (not a plain class): it is mixed into
    # KwargsForCausalLM(FlashAttentionKwargs, LossKwargs), and Python forbids a
    # TypedDict from inheriting a non-TypedDict base class.
