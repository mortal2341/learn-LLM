...
# 打印所有参数的shape和名称
print("Model Paramertes and Shape:")
...
# 保存模型和tokenizer
model.save_pretrained("./saved/pretrain/pretrain-qwen-0.1B/")  # 保存模型的路径
tokenizer.save_pretrained("./saved/pretrain/pretrain-qwen-0.1B/")


# 保存训练日志
with open("log/pretrain_running_states.json", "w", encoding="utf-8") as fw:
